...
class BalitangVideoPage extends StatefulWidget {
  String thumbnail;
  String title;
  String videoUrl;

  BalitangVideoPage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _BalitangVideoPageState createState() => _BalitangVideoPageState();
}

class _BalitangVideoPageState extends State<BalitangVideoPage> {
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (_) => BalitangVideoPage(
                                                    title: balitang[index]
                                                        ['title'],
                                                    thumbnail: balitang[index]
                                                        ['thumnail_img'],
                                                    videoUrl: balitang[index]
                                                        ['video_url'],
                                                  )));
                                    },
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              colorFilter: ColorFilter.mode(
                                                  ...
                                                  BlendMode.dstATop),
                                              image: AssetImage(balitang[index]
                                                  ['thumnail_img']),
                                              fit: BoxFit.cover)),
                                      child: new Align(
