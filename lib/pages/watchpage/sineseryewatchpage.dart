...
class SineseryeVideoPage extends StatefulWidget {
  String thumbnail;
  String title;
  String videoUrl;

  SineseryeVideoPage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _SineseryeVideoPageState createState() => _SineseryeVideoPageState();
}

class _SineseryeVideoPageState extends State<SineseryeVideoPage> {
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              colorFilter: ColorFilter.mode(
                                                  ...
                                                  BlendMode.dstATop),
                                              image: AssetImage(sineserye[index]
                                                  ['thumnail_img']),
                                              fit: BoxFit.cover)),
                                      child: new Align(
