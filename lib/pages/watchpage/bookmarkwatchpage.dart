...
class BookmarkVideoPage extends StatefulWidget {
  String thumbnail;
  String title;
  String videoUrl;

  BookmarkVideoPage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _BookmarkVideoPageState createState() => _BookmarkVideoPageState();
}

class _BookmarkVideoPageState extends State<BookmarkVideoPage> {
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              colorFilter: ColorFilter.mode(
                                                  ...
                                                  BlendMode.dstATop),
                                              image: AssetImage(bookmarks[index]
                                                  ['thumnail_img']),
                                              fit: BoxFit.cover)),
                                      child: new Align(
