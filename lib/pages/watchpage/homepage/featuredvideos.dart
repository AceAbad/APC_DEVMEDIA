...
class FeaturedVideoPage extends StatefulWidget {
  String thumbnail;
  String title;
  String videoUrl;

  FeaturedVideoPage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _FeaturedVideoPageState createState() => _FeaturedVideoPageState();
}

class _FeaturedVideoPageState extends State<FeaturedVideoPage> {
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              colorFilter: ColorFilter.mode(
                                                  ...
                                                  BlendMode.dstATop),
                                              image: AssetImage(featured[index]
                                                  ['thumnail_img']),
                                              fit: BoxFit.cover)),
                                      child: new Align(
