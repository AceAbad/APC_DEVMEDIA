...
class LatestVideoPage extends StatefulWidget {
  ...
  LatestVideoPage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _LatestVideoPageState createState() => _LatestVideoPageState();
}
