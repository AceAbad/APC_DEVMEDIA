...
class PSAVideoPagePage extends StatefulWidget {
  String thumbnail;
  String title;
  String videoUrl;

  PSAVideoPagePage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _PSAVideoPagePageState createState() => _PSAVideoPagePageState();
}

class _PSAVideoPagePageState extends State<PSAVideoPagePage> {
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              colorFilter: ColorFilter.mode(
                                                  ...
                                                  BlendMode.dstATop),
                                              image: AssetImage(psa_watch[index]
                                                  ['thumnail_img']),
                                              fit: BoxFit.cover)),
                                      child: new Align(
