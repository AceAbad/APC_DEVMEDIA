...
class InterviewsVideoePage extends StatefulWidget {
  String thumbnail;
  String title;
  String videoUrl;

  InterviewsVideoePage({Key key, this.thumbnail, this.title, this.videoUrl})
      : super(key: key);
  @override
  _InterviewsVideoePageState createState() => _InterviewsVideoePageState();
}

class _InterviewsVideoePageState extends State<InterviewsVideoePage> {
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (_) =>
                                                  InterviewsVideoePage(
                                                    title: inter_views[index]
                                                        ['title'],
                                                    thumbnail:
                                                        inter_views[index]
                                                            ['thumnail_img'],
                                                    videoUrl: inter_views[index]
                                                        ['video_url'],
                                                  )));
                                    },
                                    child: Container(
